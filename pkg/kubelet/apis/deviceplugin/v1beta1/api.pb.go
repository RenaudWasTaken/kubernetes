...
type ContainerAllocateResponse struct {
	...
	// Prestart hook to be passed down directly to the OCI spec
	PrestartHook string `protobuf:"bytes,5,opt,name=prestart_hook,json=prestartHook,proto3" json:"prestart_hook,omitempty"`
}
...
func (m *ContainerAllocateResponse) GetPrestartHook() string {
	if m != nil {
		return m.PrestartHook
	}
	return ""
}
...
func (m *ContainerAllocateResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.PrestartHook) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintApi(dAtA, i, uint64(len(m.PrestartHook)))
		i += copy(dAtA[i:], m.PrestartHook)
	}
	return i, nil
}
...
func (this *ContainerAllocateResponse) String() string {
	...
	s := strings.Join([]string{`&ContainerAllocateResponse{`,
		...
		`PrestartHook:` + fmt.Sprintf("%v", this.PrestartHook) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *ContainerAllocateResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrestartHook", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PrestartHook = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipApi(dAtA[iNdEx:])
...
var fileDescriptorApi = []byte{
	...
	,
}
