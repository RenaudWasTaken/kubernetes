...
func autoConvert_v1_ContainerStatus_To_api_ContainerStatus(in *v1.ContainerStatus, out *api.ContainerStatus, s conversion.Scope) error {
	...
	out.ContainerID = in.ContainerID
	out.Devices = *(*[]api.Device)(unsafe.Pointer(&in.Devices))
	return nil
}
...
func autoConvert_v1_Device_To_api_Device(in *v1.Device, out *api.Device, s conversion.Scope) error {
	out.Kind = in.Kind
	out.Vendor = in.Vendor
	out.Name = in.Name
	out.Health = api.DeviceHealthStatus(in.Health)
...
func Convert_v1_Device_To_api_Device(in *v1.Device, out *api.Device, s conversion.Scope) error {
	return autoConvert_v1_Device_To_api_Device(in, out, s)
}

func autoConvert_api_Device_To_v1_Device(in *api.Device, out *v1.Device, s conversion.Scope) error {
	out.Kind = in.Kind
	out.Vendor = in.Vendor
	out.Name = in.Name
	out.Health = v1.DeviceHealthStatus(in.Health)
	out.Properties = *(*map[string]string)(unsafe.Pointer(&in.Properties))
	return nil
}

// Convert_api_Device_To_v1_Device is an autogenerated conversion function.
func Convert_api_Device_To_v1_Device(in *api.Device, out *v1.Device, s conversion.Scope) error {
...
func autoConvert_api_NodeStatus_To_v1_NodeStatus(in *api.NodeStatus, out *v1.NodeStatus, s conversion.Scope) error {
	out.Capacity = *(*v1.ResourceList)(unsafe.Pointer(&in.Capacity))
	out.DevCapacity = *(*[]v1.Device)(unsafe.Pointer(&in.DevCapacity))
